...
Considerando otro número para un ciclo más largo (por ejemplo $`r options(scipen=9); z0 <- 5675431 ; z0 `$), Â¿qué tan aleatorios se ven los números y cómo lo podemos verificar? Â¿Qué pruebas podemos hacer para verificar aleatoriedad? Algunos ejemplos se muestran a continuación
...
```{r}
x <- tan(pi*(runif(1000) - 0.5))
hist(x, xlim = c(-100,100), breaks = 50)

# Ahora probando si la muestra efectivamente viene d ela distribucion Cauchy
ks.test(x, "pcauchy")
```
