...
#' Esta función llama a cada subrutina para llevar a cabo la simulación y general el reporte correspondiente.
#' @param lambdaA Tiempo promedio de interarribo de los clientes. Es la media de la distribución de llegadas.
#' @param lambdaS Tiempo promedio de servicio.
#' @param n Número de clientes que entraran al sistema. Es fijado de antemano.
#' @return Regresa una lista de variables que representan un reporte de lo ocurrido en la simulación.
#' @examples
#' mm1()
#' mm1(16, 15, 100)
#' mm1(n = 50, lambdaA = 10, lambdas = 30)
mm1 <- function(lambdaA = 15, lambdaS = 10, n = 100) {
  ...
  while (clientes_enespera < n) {
    ...
    # Llama la función de evento dependiendo del siguiente evento
