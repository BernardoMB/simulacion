...
$$\begin{aligned}
  Z_0 &\equiv Z_0 \quad \mathrm{mod} \quad m  \\
            &\equiv  a^0Z_0+c\frac{a^0-1}{a-1} \quad \mathrm{mod} \quad m,
\end{aligned}$$

y para $i=1$ se tiene que

$$\begin{aligned}
  Z_1 &\equiv  aZ_0 + c  \quad \mathrm{mod} \quad m  \\
      &\equiv  a^1Z_0+c\frac{a^1-1}{a-1} \quad \mathrm{mod} \quad m.
\end{aligned}$$

Procediendo por indución matemática, se supone válido para $i$ de manera que 

$$\begin{aligned}
  Z_{i+1} &\equiv  aZ_i + c  \quad \mathrm{mod} \quad m  \\
      &\equiv  a\left(a^iZ_0+c\frac{a^i-1}{a-1}\right)+c \quad \mathrm{mod} \quad m \\
      &\equiv  a^{i+1}Z_0+c\frac{a^{i+1}-1}{a-1} \quad \mathrm{mod} \quad m. \\
\end{aligned}$$
...
¿Qué se puede decir del periodo de $Z_{i} &\equiv 630,360,016Z_{i-1} \quad \mathrm{mod} \quad 2^{31}-1$?
